...
public class MastercraftsmentDto {
	...
	public String toString() {
		return "MastercraftsmentDto [descrId=" + descrId + ", description=" + description + ", docregstartdt="
	...
	public MastercraftsmentDto() {
		super();
	}

	public MastercraftsmentDto(Integer descrId, String description, String docregstartdt, String docregenddt,
