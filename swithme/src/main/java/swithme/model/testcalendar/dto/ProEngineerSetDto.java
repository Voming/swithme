...
public class ProEngineerSetDto {
	...
	public String toString() {
		return "ProEngineerSetDto [description=" + description + ", docregstartdt=" + docregstartdt + ", docregenddt="
	...
	public ProEngineerSetDto(String description, String docregstartdt, String docregenddt, String docregstartdtEx,
