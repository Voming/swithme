...
public class ProengineerDto {
	...
	public String toString() {
		return "ProengineerDto [descrId=" + descrId + ", description=" + description + ", docregstartdt="
				+ docregstartdt + ", docregenddt=" + docregenddt + ", docexamdt=" + docexamdt + ", docpassdt="
				+ docpassdt + ", pracregstartdt=" + pracregstartdt + ", pracregenddt=" + pracregenddt
				+ ", pracexamstartdt=" + pracexamstartdt + ", pracexamenddt=" + pracexamenddt + ", pracpassdt="
				+ pracpassdt + "]";
	}

	public ProengineerDto() {
		super();
	}

	public ProengineerDto(Integer descrId, String description, String docregstartdt, String docregenddt,
